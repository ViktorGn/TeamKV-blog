...
module.exports = (app, config) => {
    ...
    // app.use method tells the app to use the parameters you're giving it. This can be a function or a path and a function.
    ...
    // Use express-fileupload for upload of files
    app.use(fileUpload());
};
